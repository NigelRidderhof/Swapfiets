...
function revealWheel() {
    controls.enabled = false; 
    createjs.Tween.get( scene.getObjectByName( "revealWall" ).position )
        .to( { y: -6 }, 2500, createjs.Ease.getPowInOut( 5 ) );
    createjs.Tween.get( scene.getObjectByName( "revealWall2" ).position )
        .to( { y: -6 }, 2500, createjs.Ease.getPowInOut( 5 ) );
    createjs.Tween.get( scene.getObjectByName( "revealButton" ).position )
        .to( { y: -6 }, 4000, createjs.Ease.getPowInOut( 5 ) );
    createjs.Tween.get( scene.getObjectByName( "triangleRevealButton" ).position )
        .to( { y: -6 }, 4000, createjs.Ease.getPowInOut( 5 ) );
    createjs.Tween.get( camera.position )
        .to( cameraStartPosition, 3000, createjs.Ease.getPowInOut( 5 ) )
        .call( () => { 
